    ...
    <aside className="w-64 bg-gray-900 text-white flex flex-col h-full border-r border-gray-800 shrink-0">
      ...
      <nav className="flex-1 overflow-y-auto mt-2 custom-scrollbar px-3 pb-4">
        <ul className="space-y-1.5">
          ...
          <li><Link href="/?disciplina=Internacional" className={`flex items-center px-4 py-2.5 font-medium rounded-xl transition-colors ${currentDisciplina === 'Internacional' ? 'bg-emerald-600 text-white shadow-md' : 'text-gray-300 hover:bg-[#111111] hover:text-white'}`}><span className="mr-3 text-lg">🌍</span> Internacional</Link></li>
        </ul>
      </nav>
    </aside>
  );
